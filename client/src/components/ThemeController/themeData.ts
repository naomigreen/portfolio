...
export const dark = {
  ...
  companyLogo:
    'linear-gradient(167deg, rgb(133 165 203) 0%, rgb(133 165 203) 100%)',
  companyIcon: '#bcd8ff',
  divider:
    'linear-gradient(to right, rgb(14 27 41), rgb(188 216 255), rgb(15 28 42))',
  placeholder: '#696969',
  input: '#1c3956',
  border: '#363737',
  error: '#ad2828',
...
export const light = {
  ...
  companyLogo:
    'linear-gradient(167deg, rgb(50 62 74) 0%, rgb(105 109 110) 25%, rgb(209 202 189) 50%, rgb(105 109 110) 75%, rgb(50 62 74) 100%)',
  companyIcon: '#c6c1b3',
...
export const cool = {
  ...
  companyLogo:
    'linear-gradient(0deg, rgb(42 186 213) 0%, rgb(255 19 250) 100%)',
  companyIcon: '#e959e1',
...
export const fairy = {
  ...
  companyLogo:
    'linear-gradient(0deg, rgb(234 175 245) 0%, rgb(255 178 218) 100%)',
  companyIcon: '#ffb2da',
...
export const themeData: themeDataType[] = [
  {
    icon: '/icons/moon.png',
    background: '/backgrounds/dark3.jpg',
    name: 'dark',
  },
  {
    icon: '/icons/sun.png',
    background: '/backgrounds/light.jpg',
    name: 'light',
  },
  {
    icon: '/icons/cool.png',
    background: '/backgrounds/cool.jpg',
    name: 'cool',
  },
  {
    icon: '/icons/fairy.png',
    background: '/backgrounds/fairy.jpg',
    name: 'fairy',
  },
]
